...
public class ForecastFragment extends Fragment {
    ...
    public String LOG_TAG = FetchWeatherTask.class.getSimpleName();
    ...
    public String readWeatherResponseFromServer(String postalCode) {
        ...
        try {
            ...
            builder.scheme("http")
                    ...
                    .appendPath("forecast")
                    .appendPath("daily")
                    .appendQueryParameter("q", /*"94043"*/postalCode)
    ...
    class FetchWeatherTask extends AsyncTask<String, Void, String []> {
        ...
        protected String [] doInBackground(String ... postalCode) {
            ...
            try {
                return getWeatherDataFromJson(readWeatherResponseFromServer(postalCode[0]), 7);
            }
